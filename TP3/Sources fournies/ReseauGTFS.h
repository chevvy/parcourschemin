...
private:
    ...
    const unsigned int delaisMinArcsAttente = 300; // le délais minimal pour les arcs d'attentes en secondes
    ...
    void ajouterArcsAttente(const DonneesGTFS & p_gtfs); //ajout des arcs d'attente
